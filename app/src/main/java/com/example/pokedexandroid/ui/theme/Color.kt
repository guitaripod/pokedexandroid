package com.example.pokedexandroid.ui.theme
...
// Stat Colors
val HPColor = Color(0xFFFF5959)
val AttackColor = Color(0xFFF5AC78)
val DefenseColor = Color(0xFFFAE078)
val SpAttackColor = Color(0xFF9DB7F5)
val SpDefenseColor = Color(0xFFA7DB8D)
val SpeedColor = Color(0xFFFA92B2)
